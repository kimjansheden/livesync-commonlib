...
| A scanner reports an alert while ordinary tests remain green                       | The required CodeQL job queries CodeQL, Dependabot, and secret scanning and fails closed for malformed responses, stale analyses, or any open alert. |
